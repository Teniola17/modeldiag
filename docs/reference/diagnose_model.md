...
This is a generic function for performing diagnostic checks on
statistical models. It dispatches to specific methods based on the model
type.
...
An object of class "model_diagnostics" containing the results of various
diagnostic tests.

...
The `summary()` output categorizes diagnostics as:

* **PASS**: Assumption appears satisfied
* **WARNING**: Potential issue detected
* **FAIL**: Clear violation of assumptions

These diagnostics should guide model refinement, transformation, or alternative model selection.
